...
export function WebSiteSchema() {
  const schema = {
    ...
    url: process.env.NEXT_PUBLIC_SITE_URL || 'https://memcard.app',
    ...
    potentialAction: {
      ...
      target: {
        '@type': 'EntryPoint',
        urlTemplate: `${process.env.NEXT_PUBLIC_SITE_URL || 'https://memcard.app'}/search?q={search_term_string}`,
      },
...
export function OrganizationSchema() {
  const schema = {
    ...
    name: 'MemCard',
    url: process.env.NEXT_PUBLIC_SITE_URL || 'https://memcard.app',
    logo: `${process.env.NEXT_PUBLIC_SITE_URL || 'https://memcard.app'}/icon-512x512.png`,
