...
CREATE OR REPLACE FUNCTION get_user_games_filtered_paginated(
  ...
  p_status_filter TEXT DEFAULT 'all', -- 'all', 'playing', 'completed', 'backlog'
  p_tab TEXT DEFAULT 'collection', -- 'collection' or 'wishlist'
  p_sort_order TEXT DEFAULT 'date_desc', -- 'date_desc', 'date_asc', 'alphabetical'
