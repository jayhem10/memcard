-- Migration pour corriger les conflits de username dans handle_new_user
-- Cette migration résout les problèmes d'authentification Google où les comptes
-- avec des emails similaires génèrent le même username
...
DO $$
BEGIN
  RAISE NOTICE '✅ Fonction handle_new_user mise à jour pour gérer les conflits de username';
END $$;
